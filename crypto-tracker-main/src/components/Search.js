    ...
    "
      ...
      >
        <input
          ...
          value={searchText}
          className="w-64 rounded bg-gray-200
        ...
        />
        <button type="submit" className="absolute right-1 cursor-pointer mr-2">
          <img src={searchIcon} className="w-full h-auto" alt="search" />
        </button>
      </form>
      {searchText.length > 0 ? (
        <ul
          className="absolute top-11 right-0 w-full sm:w-96 h-96 rounded
...
"
        >
          {searchData ? (
            ...
            >
              <div
                className="w-8 h-8 border-4 border-blue rounded-full
